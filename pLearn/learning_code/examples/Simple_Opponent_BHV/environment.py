...
class Constants:
   def __init__(self):
      ...
      learning_path = 'moos-ivp-pLearn/pLearn/learning_code/'
      simulation_path = 'moos-ivp-pLearn/pLearn/simulation_engine/'
      ...
      self.eval_address = user_path+learning_path+'examples/Simple_Opponent_BHV/topModel/'
